 ...
 */
final class Version20210208121339 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE material_order_position ADD direct_order_position_id VARCHAR(255) DEFAULT NULL');
