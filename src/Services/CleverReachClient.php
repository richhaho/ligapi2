...
class CleverReachClient
{
    ...
    public string $url = "http://nourl.com";
    
    public string $postFormat = "json";
    public string $returnFormat = "json";
    
    public string $authMode;
    public stdClass $authModeSettings;
    
    public stdClass $debugValues;
    
    public bool $checkHeader = true;
     ...
     * @return [type]
     */
    private function debug($key, $value): void
    {
        $this->debugValues->$key = $value;
    }
    
    private function debugStartTimer(): void
    {
        $this->debugValues->time = $this->microtime_float();
    }
    
    private function debugEndTimer(): void
    {
