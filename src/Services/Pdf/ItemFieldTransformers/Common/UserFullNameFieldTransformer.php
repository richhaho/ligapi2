...
class UserFullNameFieldTransformer implements ItemFieldTransformerInterface
{
    ...
    {
        return $transformer === UserFullNameFieldTransformer::class;
    }
    
    public function transform(object $entity, PdfField $pdfItemField, int $position): string
    {
        return $this->currentUserProvider->getAuthenticatedUser()->getFullName();
    }
}
