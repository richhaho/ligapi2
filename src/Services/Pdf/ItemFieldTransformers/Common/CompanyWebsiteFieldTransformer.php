...
class CompanyWebsiteFieldTransformer implements ItemFieldTransformerInterface
{
    public function supports(
        string $transformer
    ): bool
    {
        return $transformer === CompanyWebsiteFieldTransformer::class;
    }
    ...
    public function transform(object $entity, PdfField $pdfItemField, int $position): string
    {
        ...
        return $entity->getCompany()->getWebsite() ?? '';
    }
}
