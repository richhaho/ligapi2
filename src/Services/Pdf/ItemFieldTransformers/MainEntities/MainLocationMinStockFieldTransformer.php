...
class MainLocationMinStockFieldTransformer implements ItemFieldTransformerInterface
{
    ...
    {
        return $transformer === MainLocationMinStockFieldTransformer::class;
    }
    ...
    public function transform(object $entity, PdfField $pdfItemField, int $position): string
    {
        ...
        return (string) $entity->getMainLocationLinkMinStock();
    }
}
