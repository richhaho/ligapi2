...
class PermissionGroupFieldTransformer implements ItemFieldTransformerInterface
{
    public function supports(
        string $transformer
    ): bool
    {
        return $transformer === PermissionGroupFieldTransformer::class;
    }
    ...
    public function transform(object $entity, PdfField $pdfItemField, int $position): string
    {
        ...
        if ($entity instanceof Material || $entity instanceof Tool || $entity instanceof Keyy) {
            return $entity->getPermissionGroup() ? $entity->getPermissionGroup()->getName() : '';
        }
        return '';
    }
}
